...
<body>
	...
	<div id="out_div" style="position:relative;margin:0px auto 0 auto;text-align:center;">
		...
		<div id="but_div" style="position:absolute;"><a id="btn"><img id="prize_do" alt="抽奖" src="<%=uiPath%>common/imgs/wechatactivity/start.png"></a></div>
...
var isHasActivity = "${isHasActivity}";
...
function getPrize(){
	...
	isRuning = true;
     ...
     $.post("server/wechatactivity/save.htm",{openId:$("#openId").val(),activityId:$("#activityId").val(),memberId:$("#memberId").val(),zoneCode:$("#zoneCode").val()}, function (data) {
         var jsonReturn = eval("(" + data + ")");
         if (jsonReturn.flag == "1") {
             //alert(jsonReturn.prizeId);
             doRotateWheel(getHitIndex(jsonReturn.prizeId));
         } else {
        	 isRuning = false;
        	 tanchu(jsonReturn.msg);
         }
     });
}
