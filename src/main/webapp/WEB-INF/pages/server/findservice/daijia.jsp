	...
	<form id="editform">
      ...
      <script type="text/javascript">
		 ...
		 function h2y_save() {
			...
			var paraJson = "{\"memberId\":${memberUser.id},\"nickName\":\"${memberUser.nickName}\",\"account\":\"${memberUser.account}\",\"realName\":\"${memberUser.realName}\",\"clientType\":\"${appSystem}\",\"lon\":\"${locationLongitude}\",\"lat\":\"${locationLatitude}\",\"contactTel\":\""+phone+"\",\"clientTel\":\""+phone+"\",\"contactName\":\""+name+"\",\"driverCount\":\""+driverCount+"\",\"startAddress\":\"${locationAddress}\"}";
            <%--注意该处url可能不符合你的要求，请注意修改--%>
            $.post("<%=basePath%>server/third/agentDriver.htm", {paraJson:paraJson}, function (data) {
