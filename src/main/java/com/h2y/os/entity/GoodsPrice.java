...
public class GoodsPrice extends BaseObject {
	...
	public static final String key = "keyGoodsPrice";
	private long id;
	...
	public GoodsPrice(long id) {
		super();
		this.id = id;
	}

	public GoodsPrice(long id, long goodsId, long goodsTypeId, String gdsCode,
			String gdsCode2, String goodsNumber, String shortGoodsNumber,
			String goodsName, String goodsNickName, int inventory,
			int goodsUnit, int spec, String spellName, String firSpellName,
			Double maxPrice, Double minPrice, Double memberPrice,
			Double marketPrice, Double sellPrice, int version, int status,
			Date createDate, Date shelvesDate, int clickRate, int sellRate,
			String markIds, String markInfoIds, long ord, String memo,
			Date updateDate, long userId, long sellUnit, int isLimitSell,
			int isAllowGrade, int isGiftGrade, long limitSellNumber,
			Double limitGradeNumber, long limitGiftNumber, int isMallVisible,
			String gdsQr1, String gdsQrInside, Double sparePrice1,
			Double sparePrice2, long markIds2, int goodsSource, Date addedDate,
			int goodsVersion, int goodsStatus, String zoneCode, long unitId,
			int unitType, int isActivity, Double activityPrice,
			long activityGoodsId, int activityType, int isGift, int isRelation,
			long weight, long isAd, Double allowGradePrice,
			int goodsEditStatus,String s3ucode,String goodsScode,String goodsScode2, String s3gdscode, Date s3createdate) {
		super();
		this.id = id;
	...
	public String toString() {
		return "id:" + id + "\t" + "goodsId:" + goodsId + "\t" + "goodsTypeId:"
				+ goodsTypeId + "\t" + "gdsCode:" + gdsCode + "\t"
				+ "gdsCode2:" + gdsCode2 + "\t" + "goodsNumber:" + goodsNumber
				+ "\t" + "shortGoodsNumber:" + shortGoodsNumber + "\t"
				+ "goodsName:" + goodsName + "\t" + "goodsNickName:"
				+ goodsNickName + "\t" + "inventory:" + inventory + "\t"
				+ "goodsUnit:" + goodsUnit + "\t" + "spec:" + spec + "\t"
				+ "spellName:" + spellName + "\t" + "firSpellName:"
				+ firSpellName + "\t" + "maxPrice:" + maxPrice + "\t"
				+ "minPrice:" + minPrice + "\t" + "memberPrice:" + memberPrice
				+ "\t" + "marketPrice:" + marketPrice + "\t" + "sellPrice:"
				+ sellPrice + "\t" + "version:" + version + "\t" + "status:"
				+ status + "\t" + "createDate:" + createDate + "\t"
				+ "shelvesDate:" + shelvesDate + "\t" + "clickRate:"
				+ clickRate + "\t" + "sellRate:" + sellRate + "\t" + "markIds:"
				+ markIds + "\t" + "markInfoIds:" + markInfoIds + "\t" + "ord:"
				+ ord + "\t" + "memo:" + memo + "\t" + "updateDate:"
				+ updateDate + "\t" + "userId:" + userId + "\t" + "sellUnit:"
				+ sellUnit + "\t" + "isLimitSell:" + isLimitSell + "\t"
				+ "isAllowGrade:" + isAllowGrade + "\t" + "isGiftGrade:"
				+ isGiftGrade + "\t" + "limitSellNumber:" + limitSellNumber
				...
				+ "\t" + "s3ucode:" + s3ucode + "\t" + "goodsScode:"
				+ goodsScode2+ "\t" + "goodsScode2:" + goodsScode2
