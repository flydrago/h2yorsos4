...
public class SysUnits extends BaseObject{
	...
	public SysUnits(long id,String unitCode,long parentId,String zoneCode,String unitDomain,String unitName,String shortName,Date regDate,Date stopDate,long userCount,String unitStatus,String adminUrl,String portalUrl,String unitAddress,String telAreaCode,String tel,String telService,String fax,String legalPerson,String legalPersonMobile,String memo,int unitType,String s3ucode,String s3uname,Date s3createdate){
		super();
		this.id = id;
