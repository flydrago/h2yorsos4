 ...
 * 类描述：  会员模型
 * 创建人：侯飞龙  
 * 创建时间：2015年4月16日 下午2:41:56  
 * 修改人：侯飞龙
 * 修改时间：2015年4月16日 下午2:41:56  
 * 修改备注：  
 * @version
 */
public class MemberUser extends BaseObject{
	...
	public MemberUser(String id,String account,String password,String realName,String nickName,String sex,String birDate,String idCard,String mailAdd,String telPhone,String zone,String zoneDetail,String qrPath,String qrRelPath,String uuid,String headPath,long levelId,String openId,String regDevice,String regSource,String loginType,Date loginDate,int type,int status,Date createDate,Date updateDate,String memo,String iosPushCode,String androidPushCode,int isAgreement){
		super();
		this.id = id;
