 ...
 * 类描述：商品赠品，关联商品模型  
 * 创建人：侯飞龙  
 * 创建时间：2015年4月17日 上午11:27:05  
 * 修改人：侯飞龙
 * 修改时间：2015年4月17日 上午11:27:05  
 * 修改备注：  
 * @version
 */
public class DataGoodsInfo extends BaseObject{
	...
	public DataGoodsInfo(long id,long dataGoodsId,String dataGoodsNumber,int dataGoodsVersion,int dataGoodsCount,long goodsId,String goodsNumber,int goodsVersion,int dataType,Date createDate,int dataStatus,String zoneCode,int dataGoodsSource){
		super();
		this.id = id;
	...
	return "id:"+id+"\t"+"dataGoodsId:"+dataGoodsId+"\t"+"dataGoodsNumber:"+dataGoodsNumber+"\t"+"dataGoodsVersion:"+dataGoodsVersion+"\t"+"dataGoodsCount:"+dataGoodsCount+"\t"+"goodsId:"+goodsId+"\t"+"goodsNumber:"+goodsNumber+"\t"+"goodsVersion:"+goodsVersion+"\t"+"dataType:"+dataType+"\t"+"createDate:"+createDate+"\t"+"dataStatus:"+dataStatus+"\t"+"zoneCode:"+zoneCode+"\t"+"dataGoodsSource:"+dataGoodsSource;
    }
}