...
public class ReceiveAddress extends BaseObject{
	...
	public ReceiveAddress(long id,long memberId,long zoneId,String zoneCode,String zoneName,String zoneDetail,BigDecimal longitude,BigDecimal latitude,String receiverName,String receiverMobile,String receiverTelephone,String receiverMail,Date createDate,Date updateDate,String memo,int isDefault,int status){
		super();
		this.id = id;
